...
DMC tasks are compatible subsets of the popular OpenAI Gym framework \cite{openai.gym}, meaning many popular RL algorithm frameworks can be used with these benchmarks.
...
\begin{figure*}[p]
    ...
    \caption{
        Characterizing the Jitterbug task suite.

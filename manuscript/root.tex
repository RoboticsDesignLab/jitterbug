...
In this way, initial (random) exploration helps characterize the implicit structure of the (underactuated) action space that then focuses subsequent DRL control policy learning.


In this paper, we make two contributions.   First...
Second...

Additionally we shown that...  

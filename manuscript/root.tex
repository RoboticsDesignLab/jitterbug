...
This implicit structure suggests that an (automatic) reduction of the actuation space may make these systems more compatible with (model-free) DRL methods, which, in turn, would allow for more variable underactuated systems.

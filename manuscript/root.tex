...
\begin{table}[ht]
    ...
    {\def\arraystretch{1.2}
        \begin{tabularx}{0.95\linewidth}{$ X ^ c ^ >{\raggedleft\arraybackslash}p{2.5cm}}
            ...
            \rowstyle{\bfseries} \quad Learning Rate ($\alpha$) & & 1{\tiny E}\textsuperscript{--4} \\[6pt]
            ...
            \multicolumn{3}{r}{\boldmath$\mu = 0.3, \sigma = 0.3, \theta = 0.15$} \\[6pt]
            ...
            \quad Surrogate Optimization Epochs & & 4 \\[6pt]
...
\begin{figure*}[p]
    ...
    \centering
    \includegraphics[width=0.98\textwidth]{fig-rl-perf}
